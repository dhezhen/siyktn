...
<div>
    ...
    <input type="{{ $type }}" name="{{ $name }}" id="{{ $name }}"
        {{ $attributes->merge([
            'class' => 'block w-full rounded-xl border-0 px-4 py-3 text-sm text-slate-900 dark:text-slate-100 bg-white dark:bg-slate-800 shadow-sm ring-1 ring-inset ring-slate-300 dark:ring-slate-700 placeholder:text-slate-400 transition duration-200 ease-in-out hover:ring-slate-400 dark:hover:ring-slate-600 focus:ring-2 focus:ring-inset focus:ring-emerald-500 dark:focus:ring-emerald-400'
